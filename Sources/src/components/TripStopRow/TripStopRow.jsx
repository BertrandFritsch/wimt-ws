  ...
  render() {
    ...
    return (
        <div className={rowClasses} style={top}>
          <span className={classes}>{(DateHelpers.getDateByMinutes(SNCFData.getStopTimeTime(this.props.stopTime) + (!this.props.trainHasPassedBy ? this.props.delayedMinutes : 0))).toLocaleString('fr-FR', { hour: '2-digit', minute: '2-digit' })}</span>
